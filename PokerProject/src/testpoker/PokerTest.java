...
public class PokerTest {
	...
	// Test case 9: n = 5, cards = {"C5", "D5", "C9", "H9", "C3"}
	@Test
	public void test55993() {
		boolean result;
		String[] input = new String[] {"C5", "D5", "C9", "H9", "C3"};
		result = poker.isTwoPairs(input, 5);
		assertEquals(true, result);
	}
	
	// Test case 10: n = 5, cards = {"C5", "D6", "C9", "H9", "C3"}
	@Test
	public void test56993() {
		boolean result;
		String[] input = new String[] {"C5", "D6", "C9", "H9", "C3"};
		result = poker.isTwoPairs(input, 5);
		assertEquals(false, result);
	}
